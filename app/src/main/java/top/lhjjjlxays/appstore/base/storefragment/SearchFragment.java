...
public class SearchFragment extends BaseFragment implements
    ...
    public void onResume() {
        super.onResume();
        if (mApkGeneralList != null && mApkGeneralList.size() > 0) {
    ...
    private void initLRV(String query) {
        ...
        mApkGeneralList.clear();
        mApkGeneralMap.clear();
    }
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (result.length() < 20) {
                            ...
                            if (apkGenerals == null) {
                                ...
                                lrv_store_search_package.refreshComplete(apkGenerals.size());
    ...
    public void onItemClick(View view, int position) {
        if (position < mApkGeneralList.size()) {
